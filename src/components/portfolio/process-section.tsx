...
export function ProcessSection() {
  return (
    <section id="process" className="py-12 sm:py-20 border-b border-border">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {FREELANCE_PROCESS.map((p, i) => (
          <BlurFade key={p.step} delay={0.1 + i * 0.05}>
            <div className="h-full rounded-2xl border border-border bg-card/60 backdrop-blur-md p-4 sm:p-6 text-left hover:border-primary/40 transition-all flex flex-col justify-between group">
              <div>
