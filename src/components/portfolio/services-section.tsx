              ...
              <Card className="h-full border-border bg-card/60 backdrop-blur-md hover:border-primary/50 transition-all duration-300 hover:shadow-lg text-left group">
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex size-12 items-center justify-center rounded-xl border border-primary/30 bg-primary/10 text-primary group-hover:scale-105 transition-transform duration-300 shrink-0">
                  ...
                  <div className="pt-3">
                    ...
                    <CardDescription className="text-xs font-mono text-primary/80 mt-1">
                      {service.subtitle}
                    </CardDescription>
                  </div>
                </CardHeader>
                <CardContent className="flex flex-col gap-4 p-0 pt-2 px-6 pb-6">
